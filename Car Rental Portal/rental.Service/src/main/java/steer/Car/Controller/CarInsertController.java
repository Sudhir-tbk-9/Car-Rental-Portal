...
@MultipartConfig
public class CarInsertController<Blob> extends HttpServlet {
...
//		 Convert the picture parameter to InputStream (assuming it's coming from a file upload)
        ...
        String dealerName = (String) req.getSession().getAttribute("username");
        String dealerId = (String) req.getSession().getAttribute("mobile");
		...
		dao.saveCarsDealerInfo(carId, dealerName, dealerId);
