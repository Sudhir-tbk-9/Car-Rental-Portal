...
System.out.println("dealers visible car page dealer name : " + userName );		
System.out.println("dealers visible car page dealer ID : " + userPhone );	
...
<header class="header">
 ...
 <section>
        ...
        List<Object[]> carAndImages = dao.getAllCarAndImagesforDealer(userName,userPhone); 
        %>
